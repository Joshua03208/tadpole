...
/**
 * Branded 404 within the Wellbeing Guides chrome — shown when a guide slug
 * doesn't resolve (notFound()).
 */
  ...
  return (
    <div className="mx-auto flex w-full max-w-md flex-col items-center px-4 py-20 text-center">
      ...
      <p className="mt-2 text-sm text-ink/60">
        This guide isn&apos;t listed. It may have moved or not been published yet.
      </p>
      <Link
        href="/guides"
